...
## Snapshot
- Date: 2026-03-20
- Scope: baseline evidence + profiling + documented failures (fixed/open) + unique-sender reruns + latest big-batch theoretical push + strict no-double-count validation
